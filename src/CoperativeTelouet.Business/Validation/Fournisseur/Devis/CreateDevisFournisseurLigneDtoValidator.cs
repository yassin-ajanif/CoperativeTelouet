...
namespace CoperativeTelouet.Business.Validation.Fournisseur.Devis;

public class CreateDevisFournisseurLigneDtoValidator : AbstractValidator<CreateDevisFournisseurLigneDto>
{
    public CreateDevisFournisseurLigneDtoValidator()
    {
        RuleFor(x => x)
