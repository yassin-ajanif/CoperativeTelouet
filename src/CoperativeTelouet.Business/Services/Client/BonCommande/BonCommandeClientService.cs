      ...
      IBonCommandeClientService
{
    ...
    public Task<PagedResult<BonCommandeClientListItemDto>> GetBonsCommandeAsync(
        ...
        => RunLoggedAsync(nameof(GetBonsCommandeAsync), () =>
        {
    ...
    public Task<BonCommandeClientDto?> GetBonCommandeByIdAsync(int id, CancellationToken cancellationToken = default)
        => RunLoggedAsync(nameof(GetBonCommandeByIdAsync), async () =>
        {
    ...
    public Task<BonCommandeClientDto> CreateBonCommandeAsync(
        CreateBonCommandeClientDto dto,
        CancellationToken cancellationToken = default)
        => RunLoggedAsync(nameof(CreateBonCommandeAsync), async () =>
        {
    ...
    public Task UpdateBonCommandeAsync(
        int id,
        UpdateBonCommandeClientDto dto,
        CancellationToken cancellationToken = default)
        => RunLoggedAsync(nameof(UpdateBonCommandeAsync), async () =>
        {
            await EnsureClientExistsAsync(dto.ClientId, cancellationToken);
