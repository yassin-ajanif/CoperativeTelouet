      ...
      IDevisFournisseurService
{
    ...
    public async Task<DevisFournisseurDto?> GetDevisByIdAsync(int id, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<DevisFournisseurDto> CreateDevisAsync(
