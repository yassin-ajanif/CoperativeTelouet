...
public partial class AvoirLigneItemViewModel : ObservableObject
{
    [ObservableProperty]
    ...
    public CreateAvoirClientLigneDto ToCreateDto() => new(
        ProduitId,
        ServiceId,
        Designation.Trim(),
        Quantite,
    ...
    public static AvoirLigneItemViewModel FromDto(AvoirClientLigneDto dto) => new()
    {
    ...
    public static AvoirLigneItemViewModel FromArticle(ArticleSuggestionDto article) => new()
    {
