...
public partial class DevisListViewModel : ViewModelBase
{
    ...
    [ObservableProperty]
    private ObservableCollection<DevisClientListItemDto> _pageItems = [];

    [ObservableProperty]
    private DevisClientListItemDto? _selectedItem;
    ...
    public DevisListViewModel(IDevisClientService devis, IUserDialogService dialogs)
    {
        _devis = devis;
        _dialogs = dialogs;
    }
    ...
    public async Task LoadAsync()
    {
        try
        {
            ...
            var dateFrom = TryParseDate(DateFromText);
            var dateTo = TryParseDate(DateToText);
            ...
            PageItems = new ObservableCollection<DevisClientListItemDto>(result.Items);
