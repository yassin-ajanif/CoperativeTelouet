...
public partial class FacturationListViewModel : ViewModelBase
{
    ...
    [ObservableProperty]
    private ObservableCollection<FactureClientListItemDto> _pageItems = [];

    [ObservableProperty]
    private FactureClientListItemDto? _selectedItem;
    ...
    public FacturationListViewModel(IFactureClientService factures, IUserDialogService dialogs)
    {
        _factures = factures;
        _dialogs = dialogs;
    }
    ...
    public async Task LoadAsync()
    {
        try
        {
            ...
            PageItems = new ObservableCollection<FactureClientListItemDto>(result.Items);
