...
public partial class AvoirFournisseurLigneItemViewModel : ObservableObject
{
    [ObservableProperty]
    ...
    public decimal MontantHt => IAvoirFournisseurService.LineHt(Quantite, PrixUnitaireHt, Remise);
    public decimal MontantTtc => IAvoirFournisseurService.LineTtc(Quantite, PrixUnitaireHt, Remise, TauxTva);

    public CreateAvoirFournisseurLigneDto ToCreateDto() => new(
        ProduitId,
        ServiceId,
        Designation.Trim(),
        Quantite,
    ...
    public static AvoirFournisseurLigneItemViewModel FromDto(AvoirFournisseurLigneDto dto) => new()
    {
    ...
    public static AvoirFournisseurLigneItemViewModel FromArticle(ArticleSuggestionDto article) => new()
    {
