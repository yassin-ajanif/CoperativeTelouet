...
public partial class AvoirFournisseurListViewModel : ViewModelBase
{
    ...
    [ObservableProperty]
    private ObservableCollection<AvoirFournisseurListItemDto> _pageItems = [];

    [ObservableProperty]
    private AvoirFournisseurListItemDto? _selectedItem;
    ...
    public AvoirFournisseurListViewModel(IAvoirFournisseurService avoirs, IUserDialogService dialogs)
    {
        _avoirs = avoirs;
        _dialogs = dialogs;
    }
    ...
    public async Task LoadAsync()
    {
        try
        {
            ...
            PageItems = new ObservableCollection<AvoirFournisseurListItemDto>(result.Items);
