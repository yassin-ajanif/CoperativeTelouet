...
public partial class BonsCommandeAchatListViewModel : ViewModelBase
{
    ...
    [ObservableProperty]
    private ObservableCollection<BonCommandeFournisseurListItemDto> _pageItems = [];

    [ObservableProperty]
    private BonCommandeFournisseurListItemDto? _selectedItem;
    ...
    public BonsCommandeAchatListViewModel(IBonCommandeFournisseurService bons, IUserDialogService dialogs)
    {
        _bons = bons;
        _dialogs = dialogs;
    }
    ...
    public async Task LoadAsync()
    {
        try
        {
            ...
            PageItems = new ObservableCollection<BonCommandeFournisseurListItemDto>(result.Items);
