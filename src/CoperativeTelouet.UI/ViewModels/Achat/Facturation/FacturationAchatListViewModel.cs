...
public partial class FacturationAchatListViewModel : ViewModelBase
{
    ...
    [ObservableProperty]
    private ObservableCollection<FactureFournisseurListItemDto> _pageItems = [];

    [ObservableProperty]
    private FactureFournisseurListItemDto? _selectedItem;
    ...
    public FacturationAchatListViewModel(IFactureFournisseurService factures, IUserDialogService dialogs)
    {
        _factures = factures;
        _dialogs = dialogs;
    }
    ...
    public async Task LoadAsync()
    {
        try
        {
            ...
            PageItems = new ObservableCollection<FactureFournisseurListItemDto>(result.Items);
